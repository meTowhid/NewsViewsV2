...
public class IntroActivity extends AppCompatActivity {
    ...
    private String description_array[] = {
            "Developing android apps for the last 2+ years",
            "Rokomari Twenty-20 Android Hunt",
            "Last page of the splash activity"
    };
    ...
    private void initComponent() {
        ...
        btn_got_it.setOnClickListener(v -> finish());
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NotNull ViewGroup container, int position) {
            ...
            view.findViewById(R.id.lyt_parent).setBackgroundColor(getResources().getColor(R.color.grey_800));
