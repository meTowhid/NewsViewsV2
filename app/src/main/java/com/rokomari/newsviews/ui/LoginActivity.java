...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.sign_in_google).setOnClickListener(v -> signIn());
        mAuth = FirebaseAuth.getInstance();
        mAuthListener = auth -> {
            boolean isSuccess = auth.getCurrentUser() != null;
//            Toast.makeText(this, isSuccess ? "Login success" : "Failed", Toast.LENGTH_SHORT).show();
            if (isSuccess) finish();
        };
